        ...
        <div className="pt-20 flex w-full h-screen z-0">
            <div className="w-1/2 flex items-center justify-evenly flex-col">
                ...
                <div className='flex items-center '>
                    ...
                    <div className='flex ml-1 p-3 hover:bg-[#FFF5E1] rounded-full'>
                        <a href="mailto:voxelcraftcuentos3d@gmail.com">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#CF8D00" className="bi bi-envelope" viewBox="0 0 16 16">
                                <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1zm13 2.383-4.708 2.825L15 11.105zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741M1 11.105l4.708-2.897L1 5.383z"/>
                            </svg>
                        </a>
                    </div>
                    <div className="flex ml-1 p-3 hover:bg-[#FFF5E1] rounded-full">
                        <a href="https://www.instagram.com/voxelcraft_cuentos_3d/" >
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#CF8D00" className="bi bi-instagram" viewBox="0 0 16 16">
